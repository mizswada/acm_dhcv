        ...
        <div class="space-y-6">
          <FormKit type="form" :actions="false" @submit="handleSubmit">
            ...
            <div class="grid grid-cols-4 gap-4 mb-8">
              ...
              <div>
                ...
                <div class="flex space-x-2">
                  <input v-model="formData.vendorCode" type="text" class="flex-1 px-3 py-2 border border-[rgb(var(--border-color))] rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder="Code" />
                  <input v-model="formData.vendorName" type="text" class="flex-1 px-3 py-2 border border-[rgb(var(--border-color))] rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" placeholder="Name" />
                </div>
              </div>
              <div>
            ...
            <div class="space-y-4 mb-8">
              <h3 class="text-lg font-semibold text-[rgb(var(--text-color))]">Line Items</h3>
...
// Line items data
const lineItems = ref([
  { modelCode: '', chassisNo: '', purchaseNo: '', lotNo: '', amountExGst: '', gstTaxCodeRate: '', gstAmount: '', amountIncGst: '' },
  { modelCode: '', chassisNo: '', purchaseNo: '', lotNo: '', amountExGst: '', gstTaxCodeRate: '', gstAmount: '', amountIncGst: '' },
  { modelCode: '', chassisNo: '', purchaseNo: '', lotNo: '', amountExGst: '', gstTaxCodeRate: '', gstAmount: '', amountIncGst: '' },
  { modelCode: '', chassisNo: '', purchaseNo: '', lotNo: '', amountExGst: '', gstTaxCodeRate: '', gstAmount: '', amountIncGst: '' },
  { modelCode: '', chassisNo: '', purchaseNo: '', lotNo: '', amountExGst: '', gstTaxCodeRate: '', gstAmount: '', amountIncGst: '' },
...
const handleSubmit = async (formData) => {
  try {
    ...
    const hasLineItemData = lineItems.value.some(item => 
      item.modelCode || item.chassisNo || item.purchaseNo || item.lotNo
    );
    ...
    $swal.fire({
      title: 'Success!',
      text: 'Assembly invoice saved successfully!',
      icon: 'success',
      confirmButtonText: 'OK'
    }).then(() => {
